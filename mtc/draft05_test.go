...
var draft05Expectations = map[string]findingExpectation{
	"signature_algorithm_oid_inner":                       {"e_mtc_signature_algorithm_oid", Error, "tbsCertificate.signature", draft05Source, "6.2"},
	"signature_algorithm_oid_outer":                       {"e_mtc_signature_algorithm_oid", Error, "signatureAlgorithm", draft05Source, "6.2"},
	"signature_algorithm_parameters_present_inner":        {"e_mtc_signature_algorithm_parameters_present", Error, "tbsCertificate.signature.parameters", draft05Source, "6.2"},
	"signature_algorithm_parameters_present_outer":        {"e_mtc_signature_algorithm_parameters_present", Error, "signatureAlgorithm.parameters", draft05Source, "6.2"},
	"e_mtc_cert_signature_algorithm_mismatch":             {"e_mtc_cert_signature_algorithm_mismatch", Error, "signatureAlgorithm", draft05Source, "6.2"},
	"e_mtc_signature_value_unused_bits":                   {"e_mtc_signature_value_unused_bits", Error, "signatureValue", draft05Source, "6.2"},
	"e_mtc_ca_subject_not_ca_id":                          {"e_mtc_ca_subject_not_ca_id", Error, "tbsCertificate.subject", draft05Source, "5.5"},
	"e_mtc_ca_extension_missing":                          {"e_mtc_ca_extension_missing", Error, "tbsCertificate.extensions", draft05Source, "5.5"},
	"e_mtc_ca_extension_not_critical":                     {"e_mtc_ca_extension_not_critical", Error, "tbsCertificate.extensions", draft05Source, "5.5"},
	"f_mtc_ca_extension_malformed":                        {"f_mtc_ca_extension_malformed", Fatal, "tbsCertificate.extensions", draft05Source, "5.5"},
	"e_mtc_ca_serial_range_invalid":                       {"e_mtc_ca_serial_range_invalid", Error, "tbsCertificate.extensions.mtcCertificationAuthority", draft05Source, "5.5"},
	"e_mtc_ca_key_usage_missing":                          {"e_mtc_ca_key_usage_missing", Error, "tbsCertificate.extensions.keyUsage", draft05Source, "5.5"},
	"e_mtc_ca_key_cert_sign_missing":                      {"e_mtc_ca_key_cert_sign_missing", Error, "tbsCertificate.extensions.keyUsage", draft05Source, "5.5"},
	"e_mtc_ca_basic_constraints_missing":                  {"e_mtc_ca_basic_constraints_missing", Error, "tbsCertificate.extensions.basicConstraints", draft05Source, "5.5"},
	"e_mtc_ca_basic_constraints_not_ca":                   {"e_mtc_ca_basic_constraints_not_ca", Error, "tbsCertificate.extensions.basicConstraints", draft05Source, "5.5"},
	"w_mtc_ca_ski_not_ca_id":                              {"w_mtc_ca_ski_not_ca_id", Warning, "tbsCertificate.extensions.subjectKeyIdentifier", draft05Source, "5.5"},
	"w_mtc_ca_self_issued":                                {"w_mtc_ca_self_issued", Warning, "tbsCertificate.issuer", draft05Source, "5.5"},
	"e_mtc_subscriber_issuer_not_ca_id":                   {"e_mtc_subscriber_issuer_not_ca_id", Error, "tbsCertificate.issuer", draft05Source, "6.2"},
	"e_mtc_serial_non_positive":                           {"e_mtc_serial_non_positive", Error, "tbsCertificate.serialNumber", draft05Source, "6.2"},
	"e_mtc_serial_too_large":                              {"e_mtc_serial_too_large", Error, "tbsCertificate.serialNumber", draft05Source, "6.2"},
	"e_mtc_serial_log_number_zero":                        {"e_mtc_serial_log_number_zero", Error, "tbsCertificate.serialNumber", draft05Source, "6.2"},
	"f_mtc_proof_malformed":                               {"f_mtc_proof_malformed", Fatal, "signatureValue", draft05Source, "6.2"},
	"e_mtc_proof_range_invalid":                           {"e_mtc_proof_range_invalid", Error, "signatureValue.start,end", draft05Source, "6.2"},
	"e_mtc_proof_subtree_invalid":                         {"e_mtc_proof_subtree_invalid", Error, "signatureValue.start,end", draft05Source, "4.1"},
	"e_mtc_proof_index_outside_range":                     {"e_mtc_proof_index_outside_range", Error, "signatureValue.start,end", draft05Source, "4.3.2"},
	"e_mtc_proof_extensions_order":                        {"e_mtc_proof_extensions_order", Error, "signatureValue.extensions", draft05Source, "5.2.1"},
	"e_mtc_proof_extensions_duplicate":                    {"e_mtc_proof_extensions_duplicate", Error, "signatureValue.extensions", draft05Source, "5.2.1"},
	"e_mtc_proof_cosigner_id_empty":                       {"e_mtc_proof_cosigner_id_empty", Error, "signatureValue.signatures.cosigner_id", draft05Source, "6.2"},
	"e_mtc_proof_cosigner_order":                          {"e_mtc_proof_cosigner_order", Error, "signatureValue.signatures.cosigner_id", draft05Source, "6.2"},
	"e_mtc_proof_cosigner_duplicate":                      {"e_mtc_proof_cosigner_duplicate", Error, "signatureValue.signatures.cosigner_id", draft05Source, "6.2"},
	"e_rfc9925_unsigned_algorithm_mismatch":               {"e_rfc9925_unsigned_algorithm_mismatch", Error, "signatureAlgorithm", rfc9925Source, "3.1"},
	"e_rfc9925_unsigned_parameters_present":               {"e_rfc9925_unsigned_parameters_present", Error, "signatureAlgorithm.parameters", rfc9925Source, "3.1"},
	"e_rfc9925_unsigned_signature_not_empty":              {"e_rfc9925_unsigned_signature_not_empty", Error, "signatureValue", rfc9925Source, "3.1"},
	"e_rfc9925_unsigned_issuer_unique_id_present":         {"e_rfc9925_unsigned_issuer_unique_id_present", Error, "tbsCertificate.issuerUniqueID", rfc9925Source, "3.2"},
	"w_rfc9925_unsigned_authority_key_identifier_present": {"w_rfc9925_unsigned_authority_key_identifier_present", Warning, "tbsCertificate.extensions.authorityKeyIdentifier", rfc9925Source, "3.3"},
	"w_rfc9925_unsigned_issuer_alternative_name_present":  {"w_rfc9925_unsigned_issuer_alternative_name_present", Warning, "tbsCertificate.extensions.issuerAlternativeName", rfc9925Source, "3.3"},
}
